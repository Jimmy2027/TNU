...
MAPest = inv(X.'*X + sigma^2*eye(P(p)+1))*X.'*y.';

est_parm(k,[1:P(p)+1], p) = MAPest.';
end
end
...
title('MAP estimation of \theta_{0}');
...
title('MAP estimation of \theta_{1}');
...
title('MAP estimation of \theta_{2}');
