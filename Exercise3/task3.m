...
%% 
llh_y = -0.5 * log(2 *pi * sigma^2)-0.5*(y_hat(:,:)-y(:,:))*(y_hat(:,:)-y(:,:)')'/(sigma^2);

%% c) compute log joint distribution
priors = {} %need to do this because matlab
priors = struct('a11', normpdf(0, 0.1), 'a21', normpdf(0, 0.1), 'a22', normpdf(0, 0.1), 'b12', normpdf(0, 0.1), 'c11',normpdf(0, 0.1))
log_joint_pdf = llh_y1 * priors.a11 * priors.a21 * priors.a22
